      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return ipAdresimiAl();
          case 2:
            //asenkron sonucu beklemek için await kullandık
            _axios.default.get("https://apis.ergineer.com/ipgeoapi/".concat(benimIP)) //veri almak için get
            .then(function (response) {
              return response.data;
...
function cardOlustur(veri) {
  ...
  var p_ulke = document.createElement("p");
  p_ulke.classList.add("ulke");
  p_ulke.textContent = "".concat(veri["ülke"], " (").concat(veri["ülkeKodu"], ")");
  _infoDiv.appendChild(p_ulke);
  var dizi = ["Enlem: ".concat(veri["enlem"], " Boylam: ").concat(veri["boylam"]), "\u015Eehir: ".concat(veri["şehir"]), "Saat Dilimi: ".concat(veri["saatdilimi"]), "Para Birimi: ".concat(veri["parabirimi"]), "ISP: ".concat(veri["isp"])];
  dizi.forEach(function (p_dizi) {
